var courseData = {
  ...
  'topIntroText' : 'Unity3D是目前世界最流行的游戏开发引擎。即使从零开始学习计算机编程，也可以通过Unity3D的强大功能制作出专业的3D游戏程序。该课程通过介绍Unity3D来让学生学习编程基础的同时，动手做自己的游戏，为AP CS课程、科学竞赛、课外项目和创业充实经历。项目结束会指导带领学生参加igniteCS Programming Expo计算机竞赛。',

  'bgTitle':'名校申请强化之Unity3D游戏开发',
  'bgText':'学习、实践、竞赛、创业',
