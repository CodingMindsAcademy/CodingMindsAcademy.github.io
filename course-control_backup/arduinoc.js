var courseData = {
  'courseTitle' : 'Arduino硬件系统编程 | Coding Minds 编程思维',
  'courseDescription' : '制作智能电子系统，在硬件的世界学习软件',
  'topTitleLine1' : '电子工程师成长之路',
  'topTitleLine2' : 'Arduino硬件系统编程',
  'topGradeLevel' : '6-12 年级',
  'topIntroText' : 'Arduino是一款便捷灵活、方便上手的开源电子编程开发平台。Arduino能通过各种各样的传感器来感知环境，通过控制灯光、马达和其他的装置来反馈、影响环境。板子上的微控制器可以通过Arduino的编程语言来编写程序，通过动手操作软件和硬件，可以迅速作出自动报警装置，智能灌溉系统等专业项目。',

  'bgTitle':'Arduino硬件系统编程',
  'bgImageUrl':'img/my/arduino/arduino-bg.jpg',
  'bgText':'制作智能电子系统，在硬件的世界学习软件',
  'bgLearnMoreText':'了解更多Arduino',
  'bgLearnMoreLink':'https://www.youtube.com/embed/Fjx5EjLCPpc?autoplay=1',

  'aboutTitle':'关于课程',
  'aboutText':'制作智能电子系统，在硬件的世界学习软件',
  ...
  'promotion1':{
    'enabled':true,
    'title':'走进硬件世界的大门',
    'text':'硬件的世界丰富多彩，一个小小的Arduino可以让你完整的体验电子电路的神奇。',
  ...
  'promotion2':{
    'enabled':true,
    'title':'满足你任何想象力的传感器',
    'text':'硬件的应用取决于各种各样的传感器，发挥你的想象力，你会发现你想要的所有功能都可以被传感器所实现。',
  ...
  'promotion3':{
    'enabled':true,
    'title':'编程控制做智能设备',
    'text':'软件和程序是硬件的大脑，学习计算机的传统高级语言C语言来控制电子系统，硬件软件两不误。',
