var courseData = {
  'courseTitle' : 'iPhone手机APP开发与Swift编程 | Coding Minds 编程思维',
  'courseDescription' : '厌倦了每天玩自己的手机APP？那就学习如动手编程制作自己的手机APP，做下一个年轻的创业者',
  'topTitleLine1' : 'iPhone手机APP开发与Swift编程',
  'topTitleLine2' : '在iPhone手机上运行你自己的App',
  ...
  'aboutTitle':'关于课程',
  'aboutText':'iPhone手机APP开发与Swift编程',
  'aboutCategoryTitle':'类别',
  'aboutCategory':'游戏编程',
  'aboutGradeLevelTitle':'适合年级',
  'aboutGradeLevel':'7-12',
  'aboutSkillLevelTitle':'难度级别',
  'aboutSkillLevel':'初学到中级',
  'aboutRatioTitle':'师生比例',
  'aboutRatio':'小于1:4',

  'promotion1':{
    'enabled':true,
    'title':'学习流行的Apple Swift编程语言',
    'text':'Swift自从2014年问世以来已经逐渐成为iOS开发的主流编程语言，简洁高效的语言很适合中学生开始学习并开发App项目。',
    'imageUrl':'img/my/ios/ios0.jpg'
  },
  ...
  'promotion3':{
    ...
    'text':'通过学习iOS开发与Swift编程，编程学习变得更加有乐趣。同时，学生可以很直接的接触和了解到计算机编程中使用的核心概念，为下一步学习真正的编程打下坚实的基础。',
    'imageUrl':'img/my/ios/ios2.jpg'
  },

  'promotion4':{
    'enabled':true,
    'title':'发布和分享你自己的APP',
    'text':'整个夏令营中每个学生可以开发和发布6至10个不同的APP。就像一个专业的APP程序员和创业者，你会把自己的APP发布到谷歌的APP商店，让全世界的人通过互联网下载你的APP。',
  ...
  'goals' : [
    {
      ...
      'text':'手机APP的编程基础与计算机科学的实践'
    },
    {
      'icon':'icon-Duplicate-Window',
      'text':'熟练掌握Swift编程语言的基础'
    },
    {
      'icon':'icon-Computer',
      'text':'每天制作一个APP，做一个真正的小创业者'
    },
    {
      'icon':'icon-Idea',
      'text':'在Apple的应用商店发布自己制作的App'
    },
    {
      'icon':'icon-Affiliate',
