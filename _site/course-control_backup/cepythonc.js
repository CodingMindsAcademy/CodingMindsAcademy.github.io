var courseData = {
  'courseTitle' : '名校申请强化之Python项目实践 | Coding Minds 编程思维',
  'courseDescription' : '学习当今最流行的编程语言，挑战编程与科学竞赛',
  ...
  'promotion2':{
    'enabled':true,
    'title':'从基础到竞赛',
    'text':'Python是一个丰富强大的编程语言，因此Python常常作为编程竞赛的首选。课程将会以竞赛训练的形式进行，备战5月份的编程竞赛。',
