var courseData = {
  'courseTitle' : 'Minecraft世界开发与指令编程 | Coding Minds 编程思维',
  ...
  'promotion1':{
    'enabled':true,
    'title':'动手构建我的世界走进编程的大门',
    'text':'风靡全球的Minecraft游戏给孩子们的创造力提供了无限的空间。动手创建你想要的世界，科技电子的大门从此为你打开。',
    'imageUrl':'img/my/minecraftbasic/mc2.jpg'
  },

  'promotion2':{
    'enabled':true,
    'title':'从命令行指令中寻求编程的大道理',
    'text':'Minecraft给游戏玩家提供了一些列的游戏控制命令，通过学习这些命令，你可以完成游戏中达不到的效果。学习这些基础指令，你可以在不知不觉中建立编程的思维基础。',
