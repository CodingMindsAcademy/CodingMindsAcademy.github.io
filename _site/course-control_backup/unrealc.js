var courseData = {
  'courseTitle' : 'Unreal游戏引擎专业游戏开发 | Coding Minds 编程思维',
  'courseDescription' : '学习制作Fortnite的游戏开发引擎，让你在中学就可以挥洒创意，创作出你自己想玩的游戏。',
  'topTitleLine1' : 'Unreal游戏引擎',
  'topTitleLine2' : '专业游戏开发',
  'topGradeLevel' : '7-12 年级',
  'topIntroText' : 'Unreal是目前世界最流行的专业游戏开发引擎。如果你没有听说过Unreal，那么你一定知道风靡全球的Fortnite游戏，Fortnite就是通过Unreal引擎制作出来的。学习建模和编程，做属于你自己的Fortnite。',

  'bgTitle':'Unreal游戏引擎专业游戏开发',
  ...
  'promotion1':{
    'enabled':true,
    'title':'现在就做专业的3D游戏',
    'text':'3D游戏开发一直是计算机编程中技术难度最高的领域之一，而然Unreal引擎的强大功能让这一领域变得不再高不可攀。即使没有任何编程基础，也可以迅速学习制作专业的3D游戏。',
  ...
  'promotion3':{
    'enabled':true,
    'title':'变成Fortnite工程师',
    'text':'Fortnite的工程师用的就是Unreal，除了会玩游戏，懂得如何制作它才能玩的更好，说不定你还可以做出Fortnite 2.0',
  ...
  'promotion4':{
    'enabled':true,
    'title':'参加科学竞赛',
    'text':'Unreal做出的项目可以成为很好的科学竞赛的作品。充分发挥自己的创造力，动手解决生活中的问题，做实验，发布结果，为大学申请打下基础。',
