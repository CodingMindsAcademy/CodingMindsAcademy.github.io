angular.module('v3App', [])
  ...
  .controller('PTestController', function($scope, $location) {
    ...
    $scope.getCourseList = function(courseIds) {
      var result = "";
      for(var i = 0; i < courseIds.length; i++) {
        result += courseIds[i] + " " + coursedb.cn[courseIds[i]].name + "\n";
      }
      return result;
    }

    $scope.getCourse = function(courseId) {
      return courseId + " " + coursedb.cn[courseId].name;
    }
