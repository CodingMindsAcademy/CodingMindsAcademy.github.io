var courseData = {
  ...
  'promotion1':{
    'enabled':true,
    'title':'和你的机器人朋友一起学习',
    'text':'你将会和你的SRPK机器人一起经历这个充满挑战的夏令营。SPRK机器人永远比你想象的还要聪明，它总是能遵守你的指令去细心完成你布置的工作。你的任务是要设计出完美的程序来让SPRK机器人完成各种挑战。',
  ...
  'promotion5':{
    'enabled':true,
    'title':'专注实际的动手能力',
    'text':'W我们相信实际动手能力远远重要过理论知识。每一节课的设置都是为了让学生掌握通过编程解决具体实际问题的方法。过程中大家互相竞争，互相帮助，一起完成挑战的任',
